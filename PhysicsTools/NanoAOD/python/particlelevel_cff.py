...
HTXSCategoryTable = cms.EDProducer("SimpleHTXSFlatTableProducer",
    ...
    variables=cms.PSet(
        ...
        stage_1_1_pTjet30 = Var("stage1_1_cat_pTjet25GeV",int, doc="HTXS stage-1.1 category (jet pt>30 GeV)"),
        stage_1_1_pTjet25 = Var("stage1_1_cat_pTjet25GeV",int, doc="HTXS stage-1.1 category (jet pt>25 GeV)"),
        stage_1_1_Fine_pTjet30 = Var("stage1_1_fine_cat_pTjet25GeV",int, doc="HTXS stage-1.1 fine category (jet pt>30 GeV)"),
        stage_1_1_Fine_pTjet25 = Var("stage1_1_fine_cat_pTjet25GeV",int, doc="HTXS stage-1.1 file category (jet pt>25 GeV)"),
