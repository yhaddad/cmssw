...
// ------------------------------------------------------------------------------------------
// ---- Added by SCZ for flashgg based on original computeIdVariables method using VertexCollection ----
...
PileupJetIdentifier PileupJetIdAlgo::computeIdVariables(const pat::Jet * jet,
							...
							const std::vector<std::pair<edm::Ptr<reco::Vertex>,
							edm::Ptr<pat::PackedCandidate> > >&  vtxmap,
							bool calculateMva) {
  ...
  // Assemble collection - not needed probably
  // reco::VertexCollection allvtx;
  // for (std::map<edm::Ptr<reco::Vertex>,edm::PtrVector<pat::PackedCandidate> >::iterator it = vtxmap.begin() ; it != vtxmap.end() ; it++) {
  // allvtx.push_back(it->first);
  // }
  // initialize all variables to 0
  
  if(debug_ && std::abs(jet->eta())<2.5 && jet->pt() > 20.0 ){
    //std::cout << std::setw(6) <<"\e[0;34m";
    //std::cout << std::setw(6)  <<"-------------------------------------------------------" << std::endl;
    //std::cout << std::setw(12) << "pt";
    //std::cout << std::setw(12) << "eta";
    //std::cout << std::endl;
    //std::cout << std::setw(12) << jet->pt();
    //std::cout << std::setw(12) << jet->eta();
    //std::cout << "\e[0m"  <<std::endl;
    
    std::cout << std::setw(6) <<"\e[0;32m";
    std::cout << std::setw(6) <<"=======================================================" << std::endl;
    std::cout << std::setw(12) << "index";
    std::cout << std::setw(12) << "PDG";
    std::cout << std::setw(12) << "pt";
    std::cout << std::setw(12) << "dZ0";
    std::cout << std::setw(12) << "dZ";
    std::cout << std::setw(12) << "inVtx0";
    std::cout << std::setw(12) << "inOtherVtx";
    std::cout << "\e[0m"  <<std::endl;
  ...
  edm::Ptr<pat::PackedCandidate> lLead, lSecond, lLeadNeut, lLeadEm, lLeadCh, lTrail;
  ...
  float jetPt = jet->correctedJet(0).pt(); // use uncorrected pt for shape variables
  ...
  for (unsigned int i = 0 ; i < jet->numberOfDaughters() ; i++) {
	...
	internalId_.betaStarClassic_ += tkpt;
      ...
      bool inVtx0_me = false;
      bool inAnotherVtx_me = false;
      if( dZ0 < 0.2 ) {
	inVtx0_me = true;
	internalId_.beta_ += tkpt;
      } else if( dZ < 0.2 ) {
	inAnotherVtx_me =true;
	...
	std::cout << std::setw(12) << icand->pdgId();
	std::cout << std::setw(12) << icand->pt();
	std::cout << std::setw(12) << dZ0;
	std::cout << std::setw(12) << dZ;
	std::cout << std::setw(12) << inVtx0_me;
	std::cout << std::setw(12) << inAnotherVtx_me;
	std::cout << "\e[0m"  << std::endl;
      }
    }
    // trailing candidate
  ...
  if(debug_ && std::abs(jet->eta())<2.5 && jet->pt() > 20.0 ){
    ...
    std::cout << std::setw(12) << "pt";
    std::cout << std::setw(12) << "eta";
    std::cout << std::setw(12) << "betaStar";
    std::cout << std::setw(12) << "vtx_dz";
    std::cout << std::endl;
    std::cout << std::setw(12) << jet->pt();
    std::cout << std::setw(12) << jet->eta();
    std::cout << std::setw(12) << internalId_.betaStar_;
    std::cout << std::setw(12) << vtx->position().z();
    std::cout << "\e[0m"  <<std::endl;
  }
  if( calculateMva ) {
    runMva();
